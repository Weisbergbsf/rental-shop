...
import com.rental.shop.api.service.exceptions.DataIntegrityException;
import com.rental.shop.api.service.exceptions.ObjectNotFoundException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> validation(MethodArgumentNotValidException e, HttpServletRequest request) {
		...
		ValidationError err = new ValidationError(System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value(),
				"Error validation", e.getMessage(), request.getRequestURI());
